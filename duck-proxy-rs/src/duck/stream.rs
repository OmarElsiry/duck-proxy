...
pub fn extract_clean_b64(res: &str) -> String {
...
/// Decodes a base64-encoded image string into raw bytes, handling data URIs, padding, and whitespace.
pub fn decode_image_base64(b64: &str) -> Option<Vec<u8>> {
    use base64::Engine;
    let clean = extract_clean_b64(b64);
