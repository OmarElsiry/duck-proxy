...
fn test_config_yaml_parsing_and_fallbacks() {
    ...
    assert_eq!(empty_str_cfg.model_list.len(), 7);
    ...
    assert_eq!(empty_dict.model_list.len(), 7);
    ...
    assert_eq!(partial_cfg.model_list.len(), 7);
...
fn test_config_file_loading_and_load_or_default() {
    ...
    assert_eq!(fallback.model_list.len(), 7);
}
